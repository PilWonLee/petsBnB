...
import com.drew.execute.Execute;
...
public class TimelineController {
	...
	public @ResponseBody Map<Object, Object> uploadTimeline(MultipartHttpServletRequest req) throws Exception{
		...
		log.info("Mime Type of "+convFile.getName()+ " is "+ new MimetypesFileTypeMap().getContentType(convFile));
		Execute ex = new Execute();
		Map<String, Object> map = ex.Analysis(convFile);
		...
		timelineService.updateWeight(parmMap);
